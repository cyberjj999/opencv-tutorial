...
cv2.createTrackbar("Sat Min","TrackBars",0,255,empty)       # the max should be 255
cv2.createTrackbar("Sat Max","TrackBars",255,255,empty)
cv2.createTrackbar("Val Min","TrackBars",0,255,empty)       # the max should be 255
cv2.createTrackbar("Val Max","TrackBars",255,255,empty)

# in order to get the value, we need to put it in a loop
while True:
    img = cv2.imread("Resources/2 (6).jpeg")
