...
def getContours(img):
    ...
    for cnt in contours:        # loop through all contours
        ...
        if area>4000:    # give minimum threshold for the area to avoid any noise
...
for imageFile in os.listdir("Resources/aw-set-1"):
    # img = cv2.imread("Resources/aw-set-1/1 (5).jpeg")
    img = cv2.imread("Resources/aw-set-1/" + imageFile)
